    ...
    public function echoCsv($formName) {
           ...
           // do not output column headers
            ...
            foreach ($this->dataIterator->getDisplayColumns() as $aCol) {
                ...
                if($colDisplayValue == 'p1' || $colDisplayValue == 'p2' 
                    || $colDisplayValue == 'p3' || $colDisplayValue == 'last_name' 
                    || $colDisplayValue == 'first_name' || $colDisplayValue == 'spell_last_name' 
                    || $colDisplayValue == 'spell_first_name' || $colDisplayValue == 'name_email' 
                    || $colDisplayValue == 'domail_email' || $colDisplayValue == 'agress_provision' ) {
                    continue;
                }
        ...
        while ($this->dataIterator->nextRow()) {
            ...
            foreach ($this->dataIterator->getDisplayColumns() as $aCol) {
                ...
                if($aCol == 'p1' || $aCol == 'p2' || $aCol == 'p3' || $aCol == 'last_name' 
                    || $aCol == 'first_name' || $aCol == 'spell_last_name' 
                    || $aCol == 'spell_first_name' || $aCol == 'name_email' 
                    || $aCol == 'domail_email' || $aCol == 'agress_provision') {
                    continue;
                }
