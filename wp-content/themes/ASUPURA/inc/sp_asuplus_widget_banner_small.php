...
class SP_ASUPlus_Widget_Banner_Small extends WP_Widget {
    
    function __construct() {
        parent::__construct (
          'sp_asuplus_widget_banner_small', 
          'SP ASUPURA Banner Small',
          array(
              'description' => 'SmartPhone Banner Small Widget' 
          )
        );
    }
    ...
    function form($instance) {
        $default = array(
            'link_img' => get_template_directory_uri().'/images/banner_600-150.png',
            'href' => '#'
        );
